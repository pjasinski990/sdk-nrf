...
.. _CONFIG_TEST_TYPE_THREAD_ONLY:

CONFIG_TEST_TYPE_THREAD_ONLY
   This option enables the Bluetooth LE test type.

.. _CONFIG_TEST_TYPE_WLAN_BLE:

CONFIG_TEST_TYPE_WLAN_THREAD
...
.. _CONFIG_THREAD_INTERVAL_MIN:

CONFIG_THREAD_INTERVAL_MIN
   This option sets the Bluetooth minimum connection interval (each unit is 1.25 milliseconds).

.. _CONFIG_THREAD_INTERVAL_MAX:

CONFIG_THREAD_INTERVAL_MAX
...
* Test modes: Use the following Kconfig options to select the required test case:
  ...
  * :ref:`CONFIG_TEST_TYPE_THREAD_ONLY <CONFIG_TEST_TYPE_THREAD_ONLY>` for Bluetooth LE only test
  * :ref:`CONFIG_TEST_TYPE_WLAN_THREAD <CONFIG_TEST_TYPE_WLAN_THREAD>` for concurrent Wi-Fi and Bluetooth LE test.
...
* Bluetooth LE configuration: Set the Bluetooth LE connection interval limits using the :ref:`CONFIG_THREAD_INTERVAL_MIN <CONFIG_THREAD_INTERVAL_MIN>` and :ref:`CONFIG_THREAD_INTERVAL_MAX <CONFIG_THREAD_INTERVAL_MAX>` Kconfig options.
  The units are 1.25 milliseconds.
  For example, ``CONFIG_THREAD_INTERVAL_MIN=80`` corresponds to an interval of 100 ms (80 x 1.25).
